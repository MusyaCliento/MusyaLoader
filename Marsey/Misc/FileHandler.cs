...
public static async Task PrepareMods(string[]? path = null)
{
    ...
    string[] dumperPath = new[] { MarseyVars.MarseyDumperFolder };
    ...
    public static void LoadAssemblies(string[]? path = null, bool pipe = false, string pipename = "MarseyPatchesPipe")
    {
        ...
        foreach (string file in files)
        {
            ...
            MarseyLogger.Log(MarseyLogger.LogType.DEBG, $"Loading {fileName}");
    ...
    public static void LoadExactAssembly(string file, bool lockup = false)
    {
        ...
        {
            MarseyLogger.Log(MarseyLogger.LogType.DEBG, $"{Path.GetFileName(file)} was not found");
        }
        ...
        {
            string fileName = Path.GetFileName(file);
            MarseyLogger.Log(MarseyLogger.LogType.FATL, $"Failed to load {fileName}: {ex.Message}");
        }
        finally
        {
