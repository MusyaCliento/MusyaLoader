...
tab-proxy-dialog-socks5 = Uses SOCKS5 protocol
tab-proxy-dialog-name = Name
tab-proxy-dialog-host = Host
tab-proxy-dialog-port = Port
tab-proxy-dialog-auth-optional = Optional
tab-proxy-dialog-auth-title = Authentication
tab-proxy-dialog-user = Username
tab-proxy-dialog-pass = Password
tab-proxy-dialog-show-pass = Show
tab-proxy-dialog-host-required = Host is required.
