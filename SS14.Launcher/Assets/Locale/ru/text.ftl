...
marsey-Header-Game = Игра
marsey-Explicitly-disallow-HWID = Запретить HWID
marsey-Explicitly-disallow-HWID-1 = [Без патчей] HWId2 - Отказ от отправки вашего HWId на сервер.
marsey-Explicitly-disallow-HWID-2 = Серверы могут потребовать HWId в будущем, так как HWId2 работает (более-менее) на Linux.
marsey-Compatibility-Mode-Short = Режим совместимости
marsey-Compatibility-Mode = Использует OpenGL ES 2 (через ANGLE если необходимо), что менее подвержено ошибкам драйверов. Попробуйте это, если у вас возникают графические проблемы или крахи.
marsey-Experimental-Performance-Options-Short = Экспериментальные опции производительности
marsey-Experimental-Performance-Options = Экспериментальные переменные окружения .NET 6 которые включают полный Dynamic PGO. Отключите, если возникают проблемы.
marsey-Server-List-View = Отображение списка серверов
marsey-Server-List-Show-Time = Показывать время раунда
marsey-Server-List-Show-Players = Показывать игроков
marsey-Server-List-Show-Map = Показывать карту
marsey-Server-List-Show-Mode = Показывать режим
marsey-Server-List-Show-Ping = Показывать пинг
marsey-Server-List-View-Desc = Эти настройки управляют полями в списках Home и Servers. Цвет пинга: зеленый - хороший, желтый - средний, красный - высокий.
marsey-Hub-Settings = Настройки хабов
marsey-Hub-Settings-Desc = Измените какие серверы-хабы вы хотите использовать для получения списка серверов.
marsey-Account-Settings-Short = Настройки аккаунта
marsey-Account-Settings-Desc = Вы можете управлять настройками своего аккаунта, такими как изменение электронной почты или пароля, на нашем сайте.
tab-options-clear-engines = Очистить движки
tab-options-clear-content = Очистить контент сервера

## Marsey Options Tab - Safety Tab

marsey-Header-Safety = Безопасность
marsey-Hide-Level = Уровень скрытия
marsey-HideLevel-Desc = Устанавливает степень скрытия Marsey.
marsey-HideLevel-Disabled = Hidesey отключен. Серверы с версией движка 183.0.0 или выше вызовут критический сбой краш клиента.
marsey-HideLevel-Dublicit = Патчер скрыт от игры. Патчи остаются видимыми, чтобы администраторы могли проверить, какие именно патчи используются.
marsey-HideLevel-Normal = Патчер и патчи скрыты.
marsey-HideLevel-Explicit = Патчер и патчи скрыты. Отдельное логирование патчей отключено.
marsey-HideLevel-Unconditional = Патчер и патчи скрыты. Отдельное логирование патчей и Subversion отключены.
marsey-HideLevel-Unknown = Неизвестный уровень скрытия.

marsey-Launcher-Behavior = Поведение лаунчера
marsey-Disable-Auto-Login = Отключить автоматический вход
marsey-Disable-Auto-Login-Desc = Не входить в последний активный аккаунт при запуске лаунчера.

marsey-Game-Behavior = Поведение игры
marsey-Disable-RPC = Отключить RPC
marsey-Disable-RPC-Desc = Не позволяет Discord RPC инициализироваться, скрывая ваше имя пользователя и сервер из вашего профиля.
marsey-Fake-RPC = Подделать имя пользователя RPC
marsey-Fake-RPC-Desc = Изменяет имя пользователя в Discord Rich Presence.
marsey-RPC-Username-Desc = Установите свое имя ниже. Это имя будет показано в активности discord rich presence при наведении на большой значок.
marsey-Set-RPC-Username-Button = Установить имя пользователя

marsey-Disable-Redial = Отключить переподключение
marsey-Disable-Redial-Desc = Не позволяет администраторам игры (или самой игре) переподключить вас на другую станцию.

marsey-HWID = HWID
marsey-Force-HWID = Принудительно установить HWID
marsey-Force-HWID-Desc = Принудительно изменить HWID при подключении к серверу.
marsey-Bind-HWID = Привязать HWID к аккаунту
marsey-Bind-HWID-Desc = Привязать HWID к информации вашего аккаунта
marsey-Change-HWID = Измените ваш HWID. Может быть пустым или любой шестнадцатеричной строкой.
marsey-Set-HWID = Установить HWID
marsey-Generate-Random = Сгенерировать случайный

marsey-Patching = Патчинг
marsey-Except-On-Patch-Fail = Исключение при ошибке патча
marsey-Except-On-Patch-Fail-Desc = Выход из клиента, если какой-либо патч не может быть применен. Полезно, когда вам нужны все патчи применены или отладка патча.
marsey-Whitelist-RemoteExecuteCommand = Белый список RemoteExecuteCommand
marsey-Whitelist-RemoteExecuteCommand-Desc = Позволяет использовать RemoteExecuteCommand только для внесенных в белый список команд.
marsey-Whitelist-RemoteExecuteCommand-Warn = Может сломать функции в игре. Ваши результаты могут варьироваться.

## Marsey Options Tab - Logging Tab

marsey-Header-Logging = Логирование
marsey-Logging-Game = Игра
marsey-Open-Log-Directory = Открыть папку логов
marsey-Log-Client = Логировать клиент
marsey-Log-Client-Desc = Включает логирование любого вывода клиента игры. Полезно для разработчиков.
marsey-Log-Launcher = Логировать лаунчер
marsey-Log-Launcher-Desc = Включает логирование лаунчера. Полезно для разработчиков. (требуется перезапустить лаунчер)
marsey-Verbose-Launcher-Logging = Подробное логирование лаунчера
marsey-Verbose-Launcher-Logging-Desc = Для тех случаев, когда разработчики *очень* озадачены вашей проблемой. (требуется перезапустить лаунчер)
marsey-Log-Patches = Логировать патчер
marsey-Log-Patches-Desc = Записать вывод MarseyLogger в логи.
marsey-Enable-Launcher-Patcher-Logging = Включить логирование патчера лаунчера
marsey-Enable-Launcher-Patcher-Logging-Desc = Записать вывод MarseyLogger в stdout лаунчера.
marsey-Enable-Loader-Debug-Logs = Включить отладочные логи загрузчика
marsey-Enable-Loader-Debug-Logs-Desc = Включить режим отладки harmony, вывести IL код на рабочий стол и предоставить отладочные логи marsey.
marsey-Log-Trace-MarseyLogger = Логировать сообщения Trace MarseyLogger
marsey-Log-Trace-MarseyLogger-Desc = Записать логи трассировки MarseyLogger в stdout.
marsey-Separate-Logging = Отдельное логирование игры/патчера
marsey-Separate-Logging-Desc = Логировать вывод патчера в client.marsey.log вместо client.stdout.log.
marsey-Dump-CVars = Выгрузить Cvars

## Marsey Options Tab - Guest Tab

account-drop-down-guest-account = Гость
marsey-Header-Guest = Гость
marsey-Guest-Username = Установите имя для гостя.
marsey-Guest-Username-Watermark = Введите имя для гостя
marsey-Guest-Username-Desc = Это имя будет использоваться для гостя, не повлияет на другие аккаунты
marsey-Set-Guest-Username = Установить имя гостя

## Marsey Options Tab - Misc Tab

marsey-Header-Misc = Разное
marsey-Patchless = Запустить без патчей
marsey-Patchless-Desc = Отключает любой патчинг, кроме скрытия harmony, по сути работая как выключатель. Полезно, когда игра ломается из-за самого лаунчера.
marsey-Skip-Privacy-Policy = Пропустить политику конфиденциальности
marsey-Skip-Privacy-Policy-Desc = Пропустить показ экрана политики конфиденциальности при подключении.
marsey-Bypass-AntiHarmony = Обход Коммита e495159
marsey-Bypass-AntiHarmony-Desc = Обход этого "Memory Corruption" от визардов

marsey-Patches = Патчи
marsey-Dump-Resources = Выгрузить ресурсы
marsey-Dump-Resources-Desc = Выгружает все обращенное к клиенту на сервере и отключает себя.
marsey-Open-Dump-Directory = Открыть папку с дампами

marsey-Backports = Включить обратные порты
marsey-Backports-Desc = Применить исправления актуальные для форка и/или версии движка, если доступны.
...
marsey-Usernames = Имена пользователей
marsey-Change-Username = Измените имя вашего аккаунта на что-то другое. Это не изменяет ваше имя в игре, требуется перезагрузка.
marsey-Set-Username = Установить имя пользователя
...
marsey-resourcepack-type = Пакет ресурсов
marsey-patch-description = Описание

marsey-Header-Themes = Темы
marsey-Theme = Тема
marsey-Theme-Desc = Выберите тему лаунчера.
marsey-Theme-Dark = Тёмная
marsey-Theme-Light = Выжигатель глаз 3000
marsey-Theme-DarkRed = Тёмно-красная
marsey-Theme-DarkPurple = Тёмно-фиолетовая
marsey-Theme-MidnightBlue = Полуночно-синяя
marsey-Theme-EmeraldDusk = Изумрудный сумрак
marsey-Theme-CopperNight = Медная ночь
marsey-Theme-Custom = Своя
marsey-Theme-Custom-Colors = Цвета своей темы
marsey-Theme-Custom-Colors-Desc = Выберите свои цвета фона, акцента и текста.
marsey-Theme-Custom-Background = Цвет фона
marsey-Theme-Custom-Accent = Цвет акцента
marsey-Theme-Custom-Text = Цвет текста
marsey-Theme-Custom-Popup = Цвет всплывающих окон
marsey-Theme-Custom-Gradient-Start = Начальный цвет градиента
marsey-Theme-Custom-Gradient-End = Конечный цвет градиента
marsey-Theme-Custom-Reset = Сброс
marsey-Theme-Custom-Import = Импорт .json
marsey-Theme-Custom-Export = Экспорт .json
marsey-Theme-Gradient = Градиентный фон
marsey-Theme-Gradient-Desc = Добавляет мягкий диагональный градиент, чтобы интерфейс выглядел живее.
marsey-Theme-Decor = Декоративный узор
...
launcher-proxy-enabled = Включить proxy
launcher-proxy-enabled-desc = Применяется к HTTP-запросам лаунчера. После изменений перезапустите лаунчер.
launcher-proxy-host = Хост proxy
launcher-proxy-port = Порт proxy
launcher-proxy-username = Логин (необязательно)
launcher-proxy-password = Пароль (необязательно)
launcher-proxy-loader = Применять proxy к loader
launcher-proxy-loader-desc = Передает proxy через ALL_PROXY/HTTP_PROXY/HTTPS_PROXY в процесс SS14.Loader.
...
tab-proxy-save = Сохранить
tab-proxy-test-selected = Тест выбранного
tab-proxy-test-all = Тест всех
tab-proxy-col-name = Имя
tab-proxy-col-protocol = Протокол
tab-proxy-col-hostport = Хост:Порт
tab-proxy-col-host = Хост
tab-proxy-col-port = Порт
tab-proxy-col-user = Логин
tab-proxy-col-pass = Пароль
tab-proxy-col-tcp = Proxy RTT
tab-proxy-col-connect = TCP ping
tab-proxy-col-udp = UDP тест
proxy-status-empty = Профили proxy не настроены.
proxy-status-loaded = Загружено профилей: {$count}
proxy-status-added = Профиль добавлен.
proxy-status-removed = Профиль удален.
proxy-status-saved = Сохранено профилей: {$count}
proxy-status-active = Активный профиль: {$name}
proxy-status-testing = Выполняются тесты proxy...
proxy-status-tested = Тесты proxy завершены.
proxy-test-running = Проверка...
proxy-test-ok = OK
proxy-test-fail = Ошибка
tab-proxy-dialog-title = Профиль proxy
tab-proxy-dialog-socks5 = Использует протокол SOCKS5
tab-proxy-dialog-name = Имя
tab-proxy-dialog-host = Хост
tab-proxy-dialog-port = Порт
tab-proxy-dialog-auth-optional = Необязательно
tab-proxy-dialog-auth-title = Авторизация
tab-proxy-dialog-user = Логин
tab-proxy-dialog-pass = Пароль
tab-proxy-dialog-show-pass = Показать
tab-proxy-dialog-host-required = Поле «Хост» обязательно.
tab-proxy-dialog-save = Сохранить
tab-proxy-dialog-cancel = Отмена
tab-proxy-service-debug = Debug для ProxyService (показывать окно консоли)
tab-proxy-service-independent = Оставлять ProxyService запущенным после закрытия лаунчера
launcher-updates-rate-limit = Превышен лимит GitHub API. Повторите позже или используйте токен/прокси.
proxy-unavailable-title = Выбранный proxy недоступен
proxy-unavailable-message = Не удалось подключиться к proxy {$host}:{$port}. Proxy будет отключен для этой сессии. Выберите корректный и перезапустите лаунчер.
proxy-unavailable-ok = ОК
proxy-unavailable-settings = Настройки
